...
export default function App() {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 max-w-md mx-auto text-center items-center min-h-screen justify-center">
      ...
      <h4 className="text-xl">By inputting the name of the wikipedia page in the start and endpoint, this program can calculate the shortest path between them. This path
